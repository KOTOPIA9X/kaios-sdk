...
// src/integrations/platforms/game.ts
function createGameKaios(config) {
  return new Kaios({
    ...config,
    audioEnabled: true,
    audio: {
...
function audioProfileToFrequency(profile) {
...
function getOscillatorType(profile) {
  const map = {
    smooth: "sine",
    rough: "sawtooth",
    glitchy: "square",
...
function createSpeechBubble(speech, duration = 3e3) {
  return {
...
function getNPCBehavior(emotion) {
  const behaviors = {
    EMOTE_HAPPY: {
      movementSpeed: 1.2,
      lookAroundInterval: 2e3,
...
exports.Kaios = Kaios;
exports.audioProfileToFrequency = audioProfileToFrequency;
exports.createGameKaios = createGameKaios;
exports.createSpeechBubble = createSpeechBubble;
exports.getEmotionAnimation = getEmotionAnimation;
exports.getEmotionColors = getEmotionColors;
exports.getNPCBehavior = getNPCBehavior;
