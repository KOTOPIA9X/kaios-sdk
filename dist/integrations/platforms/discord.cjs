...
// src/integrations/platforms/discord.ts
function detectDiscordContext(content) {
...
function formatForDiscord(speech, options) {
  const { includeEmbed = false, embedColor = 9647082 } = options || {};
  let content = "";
...
async function createStatusEmbed(kaios) {
...
function createDiscordKaios(guildId, config) {
  return new Kaios({
    ...config,
...
async function handleCommand(kaios, command, args) {
  switch (command) {
    case "status":
    case "stats":
...
exports.Kaios = Kaios;
exports.createDiscordKaios = createDiscordKaios;
exports.createStatusEmbed = createStatusEmbed;
exports.detectDiscordContext = detectDiscordContext;
