...
exports.FACE_OPERATIONS = FACE_OPERATIONS;
exports.KAIMOJI_LIBRARY = KAIMOJI_LIBRARY;
exports.composeFace = composeFace;
exports.composeFaceAffect = composeFaceAffect;
...
exports.rebuildFace = rebuildFace;
exports.searchKaimojiByTag = searchKaimojiByTag;
exports.segmentFace = segmentFace;
