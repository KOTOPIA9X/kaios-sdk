...
var KAIOS_CORE_IDENTITY = {
  ...
  personality: {
    ...
    greetings: {
      ...
      cutesy: ["henloooo", "HAIIII", "henlo", "smol bean"],
      // Internet cute meme greetings
...
var EvolutionTracker = class extends EventEmitter__default.default {
  state;
  config;
...
var UserProfile = class extends EventEmitter__default.default {
  state;
...
var GlobalKaios = class extends EventEmitter__default.default {
  state;
...
var VotingSystem = class extends EventEmitter__default.default {
  api;
  config;
...
// src/core/Kaios.ts
var Kaios = class extends EventEmitter__default.default {
  config;
...
exports.Kaios = Kaios;
exports.KaiosRuntime = KaiosRuntime;
exports.LOOKS = LOOKS;
...
exports.createKaios = createKaios;
...
exports.getKaimojiByRarity = getKaimojiByRarity;
exports.getKaimojiBySoundProfile = getKaimojiBySoundProfile;
