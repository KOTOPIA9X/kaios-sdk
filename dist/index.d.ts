...
export { b as buildMusicPrompt, e as emotionToSound, s as soundToEmotion } from './emotion-mapper-CesSiSEp.js';
...
export { WebAudioSynth, WebAudioSynthOptions, createWebAudioSynth } from './audio/web/webaudio-synth.js';
export { ChatOptions, ChatResponse, SYSTEM_PROMPT, chat, chatContinue, chatStream, getModels } from './llm/index.js';
export { E as EmotionSegment, P as ParsedResponse, c as cleanResponse, a as emotionToColor, e as emotionToKaomoji, b as extractEmotions, g as getDominantEmotion, d as getEmotionName, i as isValidEmotion, p as parseResponse } from './parseEmotions-CAnwkcIs.js';
export { AttendInput, CanonicalSelf, LeakEntry, SpineAdapter, SpineConfig, SpineFacet, createSpineAdapter } from './spine/spine-adapter.js';
export { CanonicalIdentityAdapter, Expression, IdentitySnapshot, KaiosRuntime, Message, Reply, RuntimeConfig, RuntimeIdentity, SessionMemory, TextAdapter, TextRequest, TextResponse, createKaios, createSessionMemory } from './runtime/index.js';
export { CharacterDefinition, KAIOS_CHARACTER, compileCharacterPrompt } from './character/index.js';
export { AffectBus, AffectBusOptions, AffectFrame, DeepReadonly, ExternalAffectOwner, isAffectFrame, isPerformanceState } from './affect/index.js';
export { VoiceAdapter, VoiceAudio, VoiceCapabilities, VoiceRequest, VoiceResult, createNullVoiceAdapter, createVoice } from './voice/index.js';
