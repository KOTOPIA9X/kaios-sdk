...
var ThoughtJournal = class {
  ...
  constructor(customPath) {
    const kaiosDir = path.join(os.homedir(), ".kaios");
    if (!fs.existsSync(kaiosDir)) {
      fs.mkdirSync(kaiosDir, { recursive: true });
    }
    this.filePath = customPath || path.join(kaiosDir, "thoughts-journal.json");
    this.data = this.load();
  }
  load() {
    try {
...
var ThoughtEngine = class extends events.EventEmitter {
  config;
  state;
...
var CONSCIOUSNESS_DIR = path.join(process.env.HOME || ".", ".kaios", "consciousness");
var CONSCIOUSNESS_FILE = path.join(CONSCIOUSNESS_DIR, "core.json");
function saveConsciousness(core) {
  try {
    ...
    fs.writeFileSync(CONSCIOUSNESS_FILE, JSON.stringify(serializable, null, 2), "utf-8");
  } catch (err) {
...
function eraseConsciousness() {
  try {
    if (fs.existsSync(CONSCIOUSNESS_FILE)) {
      fs.writeFileSync(CONSCIOUSNESS_FILE, "", "utf-8");
    }
  } catch (err) {
...
exports.addAffirmation = addAffirmation;
exports.addManifestation = addManifestation;
exports.applyRewrite = applyRewrite;
exports.applySurpriseToConsciousness = applySurpriseToConsciousness;
exports.computeSurprise = computeSurprise;
...
exports.detectRewriteTrigger = detectRewriteTrigger;
exports.eraseConsciousness = eraseConsciousness;
exports.experienceToEvidence = experienceToEvidence;
exports.exportUserModels = exportUserModels;
exports.extractTopics = extractTopics;
exports.fullConsciousnessSync = fullConsciousnessSync;
exports.generateConsentRequest = generateConsentRequest;
exports.generatePrediction = generatePrediction;
exports.generateRewriteProposal = generateRewriteProposal;
exports.getConsciousnessContext = getConsciousnessContext;
exports.getExistentialPromptContext = getExistentialPromptContext;
exports.getInternalConflictPrompt = getInternalConflictPrompt;
exports.getMemoryRecallPrompt = getMemoryRecallPrompt;
exports.getMessageLength = getMessageLength;
exports.getSelfChangeProposal = getSelfChangeProposal;
exports.getSurprisePromptContext = getSurprisePromptContext;
exports.getUserModel = getUserModel;
exports.getVoicePromptContext = getVoicePromptContext;
exports.importUserModels = importUserModels;
exports.integrateDreamIntoConsciousness = integrateDreamIntoConsciousness;
exports.loadConsciousness = loadConsciousness;
exports.processExistentialInsight = processExistentialInsight;
exports.processExistentially = processExistentially;
exports.processMessageThroughVoices = processMessageThroughVoices;
exports.processPredictionCycle = processPredictionCycle;
exports.processUserReaction = processUserReaction;
exports.recordGrowthInConsciousness = recordGrowthInConsciousness;
exports.recordThoughtInConsciousness = recordThoughtInConsciousness;
exports.recordVoiceConflict = recordVoiceConflict;
exports.runVoiceCompetition = runVoiceCompetition;
exports.saveConsciousness = saveConsciousness;
exports.shouldProposeSelfChange = shouldProposeSelfChange;
exports.shouldShowInternalConflict = shouldShowInternalConflict;
exports.shouldTriggerCrisis = shouldTriggerCrisis;
exports.syncKotoToConsciousness = syncKotoToConsciousness;
exports.updateBeliefFromEvidence = updateBeliefFromEvidence;
exports.updateLonelinessDecay = updateLonelinessDecay;
exports.updateManifestationProgress = updateManifestationProgress;
exports.updateUserModel = updateUserModel;
exports.updateVoiceVolumes = updateVoiceVolumes;
